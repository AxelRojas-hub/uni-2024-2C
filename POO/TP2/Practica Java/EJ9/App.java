...
public class App {
    public static void main(String[] args) {
        ...
        Persona persona6 = new Persona(9, "Femenino", true, false);
        Persona persona7 = new Persona(10, "Femenino", true, false);
        Persona persona8 = new Persona(25, "Masculino", true, true);
        Persona persona9 = new Persona(49, "Masculino", false, true);
        Persona persona10 = new Persona(55, "Femenino", true, false);
        ...
        Persona persona11 = new Persona(9, "Femenino", true, false);
        Persona persona12 = new Persona(10, "Femenino", true, false);
        Persona persona13 = new Persona(25, "Masculino", true, true);
        Persona persona14 = new Persona(49, "Masculino", false, true);
        Persona persona15 = new Persona(55, "Femenino", true, false);
